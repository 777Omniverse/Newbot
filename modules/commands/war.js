...
a("LISTENNNN TOOOOO YOURRRR  FATHERRR 😘 KIDSSSSS  !");
setTimeout(() => {a({body: "F*CK YOURRR MOTHERRRR😛" })}, 3000);
setTimeout(() => {a({body: "YOUUU LITTLEEE BRATSS COMEEE OUTTTT to listen to your father curse"})}, 5000);
...
setTimeout(() => {a({body: "FUCKKKKK YOURRRR MOTHERRR MOTHERRRRFUCKERRRRR😝?" })}, 23000);
setTimeout(() => {a({body: "IIIII FUCKKKKK YOURRRR MOTHERRRR WITHOUTTTT PROTECTION 😈🦴💀" })}, 25000);
